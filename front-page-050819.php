<?php get_header(); ?>
        ...
        <img class="header-phone" src="<?php echo get_stylesheet_directory_uri() ?>/images/home-header-phone-breakpoint.jpg">


<div style="width: 100%; margin-top: 35px;">
	<div class="mobileimagecontainer" style="width: 33%; float: left;">
		<center>
			<a href="/register-to-win/" style="text-decoration: none!important;"><img class="mobileimage" src="http://skinperfectspas.com/wp-content/uploads/2017/12/register1.png" style="width: 100%; max-width: 300px; -webkit-box-shadow: 0px 0px 40px -16px rgba(0,0,0,0.75); -moz-box-shadow: 0px 0px 40px -16px rgba(0,0,0,0.75); box-shadow: 0px 0px 40px -16px rgba(0,0,0,0.75);">
	...
	<div class="mobileimagecontainer" style="width: 33%; display: inline-block;">
		<center>
			<a href="/specials/" style="text-decoration: none!important;"><img class="mobileimage" src="http://skinperfectspas.com/wp-content/uploads/2017/12/specials1.png" style="width: 100%; max-width: 300px; -webkit-box-shadow: 0px 0px 40px -16px rgba(0,0,0,0.75); -moz-box-shadow: 0px 0px 40px -16px rgba(0,0,0,0.75); box-shadow: 0px 0px 40px -16px rgba(0,0,0,0.75);">
	...
	<div class="mobileimagecontainer" style="width: 33%; float: right;">
		<center>
			<a href="/contact-us/" style="text-decoration: none!important;"><img class="mobileimage" src="http://skinperfectspas.com/wp-content/uploads/2017/12/ask2.png" style="width: 100%; max-width: 300px; -webkit-box-shadow: 0px 0px 40px -16px rgba(0,0,0,0.75); -moz-box-shadow: 0px 0px 40px -16px rgba(0,0,0,0.75); box-shadow: 0px 0px 40px -16px rgba(0,0,0,0.75);">
...
<div style="width: 100%; background-color: #13ABB6; padding: 15px; display: flex; flex-wrap: wrap; -webkit-box-shadow: 3px 3px 15px 0px rgba(0,0,0,0.35); -moz-box-shadow: 3px 3px 15px 0px rgba(0,0,0,0.35); box-shadow: 3px 3px 15px 0px rgba(0,0,0,0.35); margin-bottom: 50px;">
	...
	<div class="trialresponsive" style="width: 70%; float: left; padding: 0px 10px 0px 10px;">
		<h1 style="color: white;">First Time Visit To Skin Perfect?</h1>
		<p style="color: white; font-size: 26px;">Receive a complimentary Gift Card to be applied toward Skin Perfect treatments!</p>
		<a  class="button8" href="/trial-gift-card">Get Gift Card</a>
	</div>

	<div class="trialresponsive" style="width: 30%; float: right;">
		<img style="width: 100%; max-width: 400px;" src="http://skinperfectclinic.com/wp-content/uploads/2017/12/gc-angle.png">
	</div>
</div>
        ...
        <div class="locations">
            <div class="col-1-3">
                <p class="instruction">VISIT OR CALL ONE<br/>OF OUR LOCATIONS!</p>
            </div>
            <div class="col-2-3">
                <div class="col-1-3 location">
                    <p>POLARIS</p>
                    <p>614.846.8420</p>
                    <p>2117 Polaris Parkway</p>
					<p>Columbus, OH  43240</p>
                </div>
                <div class="col-1-3 location">
                    <p>BETHEL</p>
                    <p>614.459.3777</p>
                    <p>1061 Bethel Road</p>
